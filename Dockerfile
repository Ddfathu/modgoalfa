...
# Pasang dependensi esensial + Python3 murni untuk Alpine
...
# Salin script management user bawaan lu (addssh, delssh, listssh, menu)
...
# Salin script core proxy (Python murni yang fleksibel membaca dual-request)
