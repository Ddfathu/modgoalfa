...
# =====================================================================
# 🔥 ROMBAKAN UTAMA: PANGGIL ENGINE UTAMA GOLANG PADA PORT PUBLIK
# =====================================================================
echo "[*] Memulai GOLANG TURBO TUNNEL ENGINE di Port PUBLIK $PUBLIC_PORT..."
# 'exec' mengeksekusi biner Go sebagai PID 1 agar Railway stabil.
# Biner ini otomatis bertindak sebagai Muxing Gate sekaligus WS-Proxy internal.
exec env \
    PORT="$PUBLIC_PORT" \
